...
CoD.MainLobby.PopulateButtons_Multiplayer = function (MainLobbyButtonPane)
	...
	if Engine.IsBetaBuild() then
		MainLobbyButtonPane.body.matchmakingButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("CONNECT TO LOCALHOST"), nil, 3)
		...
		MainLobbyButtonPane.body.matchmakingButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("CONNECT TO LOCALHOST"), nil, 2)
	...
	MainLobbyButtonPane.body.matchmakingButton.hintText = Engine.Localize("Connect to a server hosted at 127.0.0.1")
	MainLobbyButtonPane.body.matchmakingButton:setActionEventName("connect_localhost")
...
CoD.MainLobby.PopulateButtons_Zombie = function (MainLobbyButtonPane)
	...
	-- CoD.SetupMatchmakingLock(MainLobbyButtonPane.body.matchmakingButton)
	MainLobbyButtonPane.body.soloPlayButton = MainLobbyButtonPane.body.buttonList:addButton(Engine.Localize("CONNECT TO LOCALHOST"), nil, 3)
	MainLobbyButtonPane.body.soloPlayButton.hintText = Engine.Localize("Connect to a server hosted at 127.0.0.1")
	MainLobbyButtonPane.body.soloPlayButton:setActionEventName("connect_localhost")
...
LUI.createMenu.MainLobby = function (LocalClientIndex)
	...
	MainLobbyWidget:registerEventHandler("connect_localhost", CoD.MainLobby.ConnectLocalhost)
...
CoD.MainLobby.ConnectLocalhost = function(MainLobbyWidget, ClientInstance)
Engine.Exec(ClientInstance.controller, "connect 127.0.0.1")
end
